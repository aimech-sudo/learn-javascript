...
const resceneKoreaMembers = ["워니", "리브", "미나리", "메이", "제나"]
...
// find: 배열안의 요소들 중 특정 조건을 만족하는 첫번째 요소를 리턴 / 조건을 만족하는 요소가 없으면 undefined 리턴합니다.
const findMember = resceneKoreaMembers.find((member) => member.length >= 2)
console.log("🚀 ~ findMember:", findMember)

/**
 * every/some: 배열안의 요소들 중 특정 조건을 만족하는 요소가 있는지 여부를 리턴
 * - some: 배열의 요소 중 하나라도 조건을 만족하면 true를 반환, 그렇지 않으면 false 리턴
